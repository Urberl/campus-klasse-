...
async function renderLernmethoden(){
  try{
    const module=await import("./modules/lernmethoden.js");
    return await module.renderLernmethoden();
  }catch(error){
    console.error("Lernmethoden-Modul konnte nicht geladen werden:",error);
    return moduleError("🧰 Lernmethoden","modules/lernmethoden.js",error);
  }
}
