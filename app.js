...
async function renderResilienz(){
  ...
  <div class="card" style="margin-top:16px">
    ...
    <div class="res-grid">${skills.map(x=>`
      <button type="button" class="card res-card" onclick="window.startResilienzSkill('${x.id}')">
...
function startResilienzSkill(id){
  ...
  modal(`<button type="button" class="modal-close" onclick="window.closeResilienzModal()">×</button>
    ...
    <div class="form-actions"><button class="secondary" onclick="window.closeResilienzModal()">Schließen</button>
    <button class="secondary" onclick="window.toggleResilienzSchatz('${id}')">☆ In meine Schatzkiste</button>
    <button class="primary" onclick="window.resilienzSkillDone()">✓ Geschafft</button></div>`);
}
