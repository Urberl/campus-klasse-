...
async function renderJournal(){
  ...
  return `${JOURNAL_LONGFORM_STYLE}${JOURNAL_TILES_CSS}
...
function openJournalForm(){
  modal(`
    ...
    <p class="muted">
      Halte deinen Lernweg ausführlich fest. Du kannst mehrere Absätze schreiben –
      deine Reflexion soll später auch noch verständlich sein, wenn du sie wieder liest.
    </p>
    ...
    <div class="form">
      ...
      <label>
        Meine ausführliche Reflexion
        <textarea
          id="jText"
          class="journal-long-text"
          rows="18"
          placeholder="Was habe ich heute / in dieser Woche gelernt?

Was ist mir besonders gut gelungen?

Was hat mich überrascht, beschäftigt oder zum Nachdenken gebracht?

Was war schwierig? Wie bin ich mit der Schwierigkeit umgegangen?

Was habe ich über mich und meine Art zu lernen erfahren?

Welche Erkenntnis nehme ich mit?

Was möchte ich noch besser verstehen, üben oder ausprobieren?

Was ist mein nächster konkreter Schritt?

Schreibe gerne ausführlich und in mehreren Absätzen. Es gibt keine kurze Zeichenbegrenzung."
        ></textarea>
      </label>

      <div class="journal-longform-hint">
        <strong>💡 Dein Lernjournal darf ausführlich sein.</strong>
        <span>
          Es geht nicht nur darum aufzuschreiben, was du gemacht hast.
          Beschreibe auch deine Gedanken, Erfahrungen, Schwierigkeiten,
          Erfolge und nächsten Schritte.
        </span>
      </div>
