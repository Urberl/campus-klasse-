...
async function renderLernwerkstatt(){
  const resources=[
         ...
         ["     ","Fragen & Hilfe","Antworten, Lernhilfe und Ansprechpartner.","fragenhilfe"]
  ];
...
async function renderFragenHilfe(){
  ...
  <style>
    .fh-top{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;margin-bottom:16px}.fh-card{height:100%}.fh-icon{font-size:30px;display:block;margin-bottom:9px}
    .fh-section{margin-top:16px}.fh-section details{border-top:1px solid var(--line,#ddd);padding:13px 0}.fh-section details:last-child{border-bottom:1px solid var(--line,#ddd)}
    .fh-section summary{cursor:pointer;font-weight:700;list-style:none}.fh-section summary::-webkit-details-marker{display:none}.fh-section summary:after{content:"＋";float:right;color:var(--muted)}.fh-section details[open] summary:after{content:"−"}
    .fh-answer{padding:9px 0 2px;line-height:1.55}.fh-steps{display:grid;gap:9px}.fh-step{display:flex;gap:10px;align-items:flex-start}.fh-step b{display:flex;align-items:center;justify-content:center;min-width:27px;height:27px;border-radius:50%;background:var(--soft-blue,#eef6fb)}
    .fh-contacts{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:12px}@media(max-width:850px){.fh-top,.fh-contacts{grid-template-columns:1fr}}
  </style>
  <div class="fh-top">
    <section class="card fh-card"><span class="fh-icon">❓</span><h2>Ich habe eine Frage</h2><p>Antworten zu Anmeldung, App, Lernjournal und Lernstandsmessungen.</p></section>
    <section class="card fh-card"><span class="fh-icon">🧭</span><h2>Ich weiß nicht weiter</h2><p>Schritt für Schritt von der Aufgabenanalyse zur eigenen Lösung.</p></section>
    <section class="card fh-card"><span class="fh-icon">👥</span><h2>Ansprechpartner</h2><p>Wer dir bei fachlichen, technischen oder persönlichen Fragen helfen kann.</p></section>
  </div>
  <section class="card fh-section"><span class="badge">❓ HÄUFIGE FRAGEN</span><h2>Anmeldung & Zugang</h2>
    <details><summary>Wie melde ich mich an?</summary><div class="fh-answer">Melde dich mit deinem persönlichen Zugang an. Nach der Anmeldung stehen dir die Bereiche zur Verfügung, die für deine Rolle freigegeben sind.</div></details>
    <details><summary>Ich kann mich nicht anmelden. Was kann ich tun?</summary><div class="fh-answer">Überprüfe Benutzername und Passwort. Wenn der Zugang weiterhin nicht funktioniert, wende dich an die zuständige Lehrkraft bzw. den schulischen Support.</div></details>
    <details><summary>Was kann ich als Schüler sehen?</summary><div class="fh-answer">Du siehst deine eigenen Lern- und Bearbeitungsdaten. Inhalte und Ergebnisse anderer Schüler sind nicht sichtbar.</div></details>
    ${teacher?`<details><summary>Was kann ich als Lehrkraft sehen?</summary><div class="fh-answer">Lehrkräfte können die vorgesehenen Schülerleistungen und Lernstände einsehen sowie Aufgaben und Musterlösungen verwalten.</div></details>`:""}
  </section>
  <section class="card fh-section"><span class="badge">📊 LERNSTANDSMESSUNGEN</span><h2>Verstehen, was du kannst</h2>
    <details><summary>Was ist eine Lernstandsmessung?</summary><div class="fh-answer">Sie überprüft, was du zu einem behandelten Thema tatsächlich kannst – nicht nur Fachwissen, sondern auch Anwendung, Analyse und reflektiertes Handeln.</div></details>
    <details><summary>Welche fünf Kompetenzen werden überprüft?</summary><div class="fh-answer"><strong>Fachwissen</strong> · <strong>Erkennen & Zuordnen</strong> · <strong>Anwenden & Erklären</strong> · <strong>Analysieren & Beurteilen</strong> · <strong>Reflektieren & Handeln</strong>.</div></details>
    <details><summary>Wie wird bewertet?</summary><div class="fh-answer">Jede Kompetenz erhält 0–3 Punkte, insgesamt 15 Punkte: 🟢 <strong>12–15 Auf Kurs</strong> · 🟡 <strong>8–11 Klärungsbedarf</strong> · 🔴 <strong>0–7 Handlungsbedarf</strong>.</div></details>
    <details><summary>Warum gibt es mehrere Versuche?</summary><div class="fh-answer">Der erste Versuch zeigt deinen aktuellen Lernstand. Danach kannst du gezielt nacharbeiten und erneut überprüfen, was du inzwischen sicher kannst.</div></details>
    <details><summary>Was passiert beim dritten Versuch?</summary><div class="fh-answer">Nach dem dritten Versuch können die hinterlegten Musterlösungen eingesehen werden. Vergleiche sie mit deiner eigenen Bearbeitung.</div></details>
  </section>
  <section class="card fh-section"><span class="badge">📈 KOMPETENZENTWICKLUNG</span><h2>Dein Lernweg ist wichtiger als ein einzelner Test.</h2><p>Die Ergebnisse werden gespeichert. So kann sichtbar werden, wie sich deine fünf Kompetenzbereiche über die Zeit entwickeln.</p><div class="notice"><strong>Frage dich nicht nur: „Welche Punktzahl habe ich?“</strong><p style="margin-bottom:0"><em>„Was kann ich heute besser als vorher?“</em></p></div></section>
  <section class="card fh-section"><span class="badge">📝 LERNJOURNAL</span><h2>Deinen Lernweg dokumentieren</h2>
    <details><summary>Wozu dient das Lernjournal?</summary><div class="fh-answer">Es hilft dir, deinen eigenen Lernprozess zu dokumentieren und zu reflektieren.</div></details>
    <details><summary>Was gehört in ein gutes Lernjournal?</summary><div class="fh-answer">Was habe ich verstanden? Was kann ich erklären? Wo kann ich es anwenden? Was war schwierig? Was möchte ich weiter üben?</div></details>
    <details><summary>Was ist eine gute Reflexion?</summary><div class="fh-answer"><strong>Weniger hilfreich:</strong> „Heute haben wir Konditionierung gelernt.“<br><br><strong>Hilfreicher:</strong> „Ich kann jetzt erklären, warum ein ursprünglich neutraler Reiz durch wiederholte Kopplung eine Reaktion auslösen kann.“</div></details>
  </section>
  <section class="card fh-section"><span class="badge">🧭 ICH WEISS NICHT WEITER</span><h2>So kommst du bei einer Aufgabe weiter</h2>
    <div class="fh-steps">
      <div class="fh-step"><b>1</b><div><strong>Aufgabe genau lesen</strong><br>Was wird tatsächlich gefragt?</div></div>
      <div class="fh-step"><b>2</b><div><strong>Fachbegriffe markieren</strong><br>Welche Begriffe könnten wichtig sein?</div></div>
      <div class="fh-step"><b>3</b><div><strong>Thema bestimmen</strong><br>Zu welchem Thema gehört die Aufgabe?</div></div>
      <div class="fh-step"><b>4</b><div><strong>Passendes Modell suchen</strong><br>Welche Theorie oder welches Konzept könnte helfen?</div></div>
      <div class="fh-step"><b>5</b><div><strong>Mit einem Beispiel arbeiten</strong><br>Kannst du die Theorie an einem Beispiel nachvollziehen?</div></div>
      <div class="fh-step"><b>6</b><div><strong>Erst selbst versuchen</strong><br>Formuliere deine eigene Lösung.</div></div>
      <div class="fh-step"><b>7</b><div><strong>Unterstützung holen</strong><br>Wenn du nicht weiterkommst, frage deine Lehrkraft.</div></div>
    </div>
  ...
  <section class="card fh-section"><span class="badge">📅 CAMPUS-KALENDER · 💡 IMPULS FÜR MICH</span><h2>Weitere Funktionen</h2>
    <details><summary>Wofür ist der Campus-Kalender da?</summary><div class="fh-answer">Hier findest du wichtige Termine und Veranstaltungen rund um die Schule.</div></details>
    <details><summary>Was ist „Impuls für mich“?</summary><div class="fh-answer">Kurze Impulse zum Nachdenken, Ausprobieren oder Reflektieren. Nimm dir das mit, was gerade zu dir passt.</div></details>
  </section>
  <section class="card fh-section"><span class="badge">👥 ANSPRECHPARTNER</span><h2>Wer kann mir helfen?</h2><div class="fh-contacts">
    <div class="card"><strong>📚 Unterricht & Fachinhalte</strong><p>Deine Fachlehrkraft</p></div>
    <div class="card"><strong>💻 Technische Probleme</strong><p>Schulischer IT-Support / zuständige Lehrkraft</p></div>
    <div class="card"><strong>🤝 Persönliche Fragen</strong><p>Beratungs- und Vertrauenspersonen der Schule</p></div>
  </div></section>
  ${teacher?`<section class="card fh-section"><span class="badge">👩‍🏫 FÜR LEHRKRÄFTE</span><h2>Arbeiten mit der Campus-App</h2><details><summary>Lernstandsmessungen verwalten</summary><div class="fh-answer">Aufgaben und Musterlösungen pflegen und den 26 Lernstandsmessungen zuordnen.</div></details><details><summary>Schülerleistungen ansehen</summary><div class="fh-answer">Bearbeitungsstände und einzelne Versuche einsehen und bewerten.</div></details></section>`:""}
  ${footer()}`;
}
...
async function render(){
  ...
  const pages={
    ...
    ressourcen:renderRessourcenRoute,lernpfad:renderLernpfadRoute,forum:renderForum,fragenhilfe:renderFragenHilfe,
