...
async function renderLernwerkstatt(){
 const resources=[["🧭","Persönlicher Lernpfad","Ziele setzen, Lernschritte planen und Fortschritt erkennen.","kompass"],["💬","Lerncoaching","Individuelle Begleitung und Kontakt zu einer Lehrkraft.","lerncoaching"],["🛠️","Lernmethoden","Planung, Lernen, Zusammenarbeit und Reflexion.","methoden"],["📚","Lernressourcen","TaskCard, KI, Videos, ByCS/mebis und Webseiten.","ressourcen"],["💡","Lernimpulse","Kurze Impulse für Reflexion und Deeper Learning.","impulse"],["📊","Lernstandsmessung","Kurz prüfen: Wo stehe ich und was ist mein nächster Schritt?","lernstand"],["🤖","KI zum Lernen","KI bewusst, kritisch und produktiv einsetzen.","ki"],["❓","Fragen & Hilfe","Wenn du nicht weiterkommst: fragen und teilen.","forum"]];
...
async function render(){
 ...
 const pages={start:renderStart,kompass:renderKompass,lernwerkstatt:renderLernwerkstatt,ressourcen:renderRessourcen,forum:renderForum,projekte:renderProjekte,kompetenz:renderKompetenz,journal:renderJournal,praktikum:renderPraktikum,ki:renderKI,kalender:renderKalender,team:renderTeam,resilienz:renderResilienz};
