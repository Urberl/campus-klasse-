...
function authError(err){
  const map={
    ...
    "auth/invalid-login-credentials":"E-Mail oder Passwort ist nicht korrekt.",
    ...
    "auth/network-request-failed":"Netzwerkfehler. Bitte Internetverbindung prüfen und erneut versuchen."
  };
