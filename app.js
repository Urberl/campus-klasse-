import {renderLernpfad} from "./modules/lernpfad.js";
import {renderRessourcen} from "./modules/lernressourcen.js";
...
const pages={start:renderStart,kompass:renderKompass,lernwerkstatt:renderLernwerkstatt,ressourcen:renderRessourcen,forum:renderForum,projekte:renderProjekte,kompetenz:renderKompetenz,journal:renderJournal,praktikum:renderPraktikum,ki:renderKI,kalender:renderKalender,team:renderTeam,resilienz:renderResilienz,lernpfad:renderLernpfad,methoden:()=>renderModulePlaceholder('lernmethoden'),impulse:()=>renderModulePlaceholder('lernimpulse'),lernstand:()=>renderModulePlaceholder('lernstand'),lerncoaching:()=>renderModulePlaceholder('lerncoaching'),kompetenzprofil:()=>renderModulePlaceholder('kompetenzprofil')};
