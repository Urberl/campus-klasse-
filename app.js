...
function resilienzImpuls(){
 const ids=["atem","boden","distanz","leicht","bewegung","summen","ressource","kontakt","fokus"];
...
function openResonanzatmung(){
 ...
 <div class="form-actions"><button class="secondary"onclick="closeResilienzModal()">Schließen</button>
 <button class="secondary"onclick="toggleResilienzSchatz('atem')"> In meine Schatzkiste</button></div>`);
}
