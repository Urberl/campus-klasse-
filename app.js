...
async function renderKalender(){
  ...
  // Schulferien Bayern im Schuljahr 2026/2027 (offizielle Ferientermine des StMUK).
  const ferienZeitraeume=[
    ["2026-08-03","2026-09-14","Sommerferien 2026"],
    ["2026-11-02","2026-11-06","unterrichtsfreie Tage um Allerheiligen"],
  ...
  ferienZeitraeume.forEach(([von,bis,label])=>{
    const start=new Date(von+"T00:00:00"), end=new Date(bis+"T00:00:00");
  ...
  <style>
    ...
    .cal-holiday{background:#ffedd5!important;border-color:#f59e0b!important}
