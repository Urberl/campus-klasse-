...
async function render(){
 ...
 const pages={start:renderStart,kompass:renderKompass,lernwerkstatt:renderLernwerkstatt,methoden:renderMethoden,lernpfad:renderLernpfad,lerncoaching:renderLerncoaching,ressourcen:renderRessourcen,forum:renderForum,projekte:renderProjekte,kompetenz:renderKompetenz,journal:renderJournal,praktikum:renderPraktikum,ki:renderKI,kalender:renderKalender,team:renderTeam};
