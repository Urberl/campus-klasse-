...
async function render(){
  ...
  const pages={
    ...
    impulse:()=>modulePlaceholder("Lernimpulse"),lernstand:()=>modulePlaceholder("Lernstandsmessung"),
    kompetenzprofil:()=>modulePlaceholder("Kompetenzprofil"),methoden:()=>modulePlaceholder("Lernmethoden"),
