...
const JOURNAL_LONGFORM_STYLE=`<style id="journal-longform-style">
.journal-textarea{
  width:100%!important;
...
.journal-reflection-hint strong{
  display:block;
  color:#476477;
  margin-bottom:3px;
}
...
function openJournalForm(){
  modal(`
    ...
    <p class="muted">
      Nimm dir Zeit für eine ausführliche Reflexion. Dieser Eintrag darf mehrere Absätze
      umfassen und soll deinen persönlichen Lernweg sichtbar machen.
    </p>

    <div class="form-grid">
      <div class="form-field">
        <label for="jTitle">Titel</label>
        <input id="jTitle" class="input"
          placeholder="z. B. Meine Erkenntnisse aus dieser Woche">
      </div>

      <div class="form-field">
        <label for="jMood">Wie geht es mir gerade?</label>
    ...
    <div class="form-field" style="margin-top:16px">
      <label for="jText">Meine ausführliche Reflexion</label>
      <textarea id="jText"
        class="input journal-textarea"
        rows="18"
        placeholder="Du kannst hier ausführlich schreiben.
...
Was möchte ich noch verstehen oder üben?

Was ist mein nächster konkreter Schritt?

Schreibe gerne in ganzen Sätzen und mehreren Absätzen."></textarea>
    </div>

    <div class="journal-reflection-hint">
      <strong>💡 Dein Lernjournal ist mehr als eine kurze Notiz.</strong>
      <span>
        Beschreibe deinen Lernweg, deine Gedanken, Schwierigkeiten, Erfolge und
        nächsten Schritte. Es gibt keine vorgegebene Maximallänge.
      </span>
    </div>
