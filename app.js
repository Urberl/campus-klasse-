...
async function renderLernimpulseRoute(){
  try{
    const module=await import("./modules/lernimpulse.js");
    return await module.renderLernimpulse();
  }catch(error){
    console.error("Lernimpulse-Modul konnte nicht geladen werden:",error);
    return moduleError("💡 Lernimpulse","modules/lernimpulse.js",error);
  }
}
...
async function render(){
  ...
  const pages={
    ...
    team:renderTeam,
    impulse:renderLernimpulseRoute,
