...
function startResilienzSkill(id){
  ...
  modal(`<button class="modal-close" type="button" onclick="closeModal()">×</button>
    ...
    <div class="form-actions"><button class="secondary" type="button" onclick="closeModal()">Schließen</button>
...
function openResilienzSchatzkiste(){
  ...
  modal(`<button class="modal-close" type="button" onclick="closeModal()">×</button><div class="kicker">MEINE RESILIENZ-SCHATZKISTE</div>
    ...
    <div class="form-actions"><button class="secondary" type="button" onclick="closeModal()">Schließen</button></div>`);
}
