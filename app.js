...
async function renderFragenHilfe(){
  ...
  return `${pageHead("ORIENTIERUNG","Fragen & Hilfe","Antworten, Lernhilfe und Ansprechpartner rund um die Campus-App.",`<button class="secondary" onclick="go('lernwerkstatt')">← Lernwerkstatt</button>`)}
  <style>
    .help-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px;margin-bottom:16px}
    .help-card{height:100%}.help-card .help-icon{font-size:30px;display:block;margin-bottom:10px}
    .help-section{margin-top:16px}.help-section h2{margin-bottom:6px}
    .help-qa details{border-top:1px solid var(--line);padding:13px 0}
    .help-qa details:last-child{border-bottom:1px solid var(--line)}
    .help-qa summary{cursor:pointer;font-weight:700;list-style:none}
    .help-qa summary::-webkit-details-marker{display:none}
    .help-qa summary:after{content:"＋";float:right;font-size:18px;color:var(--muted)}
    .help-qa details[open] summary:after{content:"−"}
    .help-answer{padding:9px 0 2px;color:var(--text)}
    .help-steps{counter-reset:helpstep;display:grid;gap:9px}
    .help-step{display:flex;gap:10px;align-items:flex-start}
    .help-step:before{counter-increment:helpstep;content:counter(helpstep);display:flex;align-items:center;justify-content:center;min-width:27px;height:27px;border-radius:50%;background:var(--soft-blue,#eef6fb);font-weight:800}
    .help-contact{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:10px}
    @media(max-width:850px){.help-grid,.help-contact{grid-template-columns:1fr}.help-card{min-height:auto}}
  </style>

  <div class="help-grid">
    <section class="card help-card"><span class="help-icon">❓</span><h2>Ich habe eine Frage</h2><p>Hier findest du Antworten zu Anmeldung, App, Lernjournal, Lernstandsmessungen und den wichtigsten Funktionen.</p><a class="secondary" href="#fragenhilfe">Häufige Fragen →</a></section>
    <section class="card help-card"><span class="help-icon">🧭</span><h2>Ich weiß nicht weiter</h2><p>Nutze die Schritte der Lernhilfe, bevor du dir die Lösung geben lässt. Ziel ist, dass du selbst weiterdenken kannst.</p><a class="secondary" href="#fragenhilfe#weiterkommen">Lernhilfe →</a></section>
    <section class="card help-card"><span class="help-icon">👥</span><h2>Ansprechpartner</h2><p>Bei fachlichen, technischen oder persönlichen Fragen findest du hier den passenden nächsten Ansprechpartner.</p><a class="secondary" href="#fragenhilfe#ansprechpartner">Ansprechpartner →</a></section>
  </div>

  <section class="card help-section help-qa">
    <span class="badge">❓ HÄUFIGE FRAGEN</span><h2>Anmeldung & Zugang</h2>
    <details><summary>Wie melde ich mich an?</summary><div class="help-answer">Melde dich mit deinem persönlichen Zugang an. Nach der Anmeldung stehen dir die Bereiche zur Verfügung, die für deine Rolle freigegeben sind.</div></details>
    <details><summary>Ich kann mich nicht anmelden. Was kann ich tun?</summary><div class="help-answer">Überprüfe zuerst Benutzername und Passwort. Wenn der Zugang weiterhin nicht funktioniert, wende dich an die zuständige Lehrkraft bzw. den schulischen Support.</div></details>
    <details><summary>Was kann ich als Schüler sehen?</summary><div class="help-answer">Du siehst deine eigenen Lern- und Bearbeitungsdaten. Inhalte und Ergebnisse anderer Schüler sind für dich nicht sichtbar.</div></details>
    ${isTeacherRole?`<details><summary>Was kann ich als Lehrkraft sehen?</summary><div class="help-answer">Lehrkräfte können die freigegebenen Schülerleistungen, Lernstände und Bearbeitungsstände einsehen sowie Aufgaben und Musterlösungen verwalten.</div></details>`:""}
  </section>

  <section class="card help-section help-qa">
    <span class="badge">📊 LERNSTANDSMESSUNGEN</span><h2>Verstehen, was du kannst</h2>
    <details><summary>Was ist eine Lernstandsmessung?</summary><div class="help-answer">Eine Lernstandsmessung überprüft, was du zu einem bereits behandelten Thema tatsächlich kannst. Es geht nicht nur um Fachwissen, sondern auch um Anwendung, Analyse und reflektiertes Handeln.</div></details>
    <details><summary>Welche fünf Kompetenzen werden überprüft?</summary><div class="help-answer"><strong>1. Fachwissen</strong> – Begriffe, Modelle und Zusammenhänge sicher kennen.<br><strong>2. Erkennen & Zuordnen</strong> – Fachliches in Beispielen erkennen.<br><strong>3. Anwenden & Erklären</strong> – Wissen auf Situationen übertragen.<br><strong>4. Analysieren & Beurteilen</strong> – Situationen fachlich untersuchen und begründet beurteilen.<br><strong>5. Reflektieren & Handeln</strong> – begründete Handlungsmöglichkeiten entwickeln.</div></details>
    <details><summary>Wie wird bewertet?</summary><div class="help-answer">Jede der fünf Kompetenzen wird mit 0 bis 3 Punkten bewertet. Insgesamt sind 15 Punkte möglich.<br><br>🟢 <strong>12–15 Punkte: Auf Kurs</strong><br>🟡 <strong>8–11 Punkte: Klärungsbedarf</strong><br>🔴 <strong>0–7 Punkte: Handlungsbedarf</strong></div></details>
    <details><summary>Warum gibt es mehrere Versuche?</summary><div class="help-answer">Der erste Versuch zeigt deinen aktuellen Lernstand. Danach kannst du gezielt nacharbeiten und die Messung erneut bearbeiten. So wird nicht nur ein Ergebnis, sondern deine Entwicklung sichtbar.</div></details>
    <details><summary>Was passiert beim dritten Versuch?</summary><div class="help-answer">Nach dem dritten Versuch können die hinterlegten Musterlösungen eingesehen werden. Vergleiche sie mit deiner eigenen Bearbeitung und überlege, was du daraus für dein weiteres Lernen mitnimmst.</div></details>
  </section>

  <section class="card help-section">
    <span class="badge">📈 KOMPETENZENTWICKLUNG</span><h2>Dein Lernweg ist wichtiger als ein einzelner Test.</h2>
    <p>Die Ergebnisse deiner Lernstandsmessungen werden gespeichert. Dadurch kann über das Schuljahr sichtbar werden, wie sich deine fünf Kompetenzbereiche entwickeln.</p>
    <div class="notice"><strong>Frage dich nicht nur: „Welche Punktzahl habe ich?“</strong><p style="margin-bottom:0">Sondern auch: <em>„Was kann ich heute besser als vorher?“</em></p></div>
  </section>

  <section class="card help-section help-qa">
    <span class="badge">📝 LERNJOURNAL</span><h2>Deinen Lernweg dokumentieren</h2>
    <details><summary>Wozu dient das Lernjournal?</summary><div class="help-answer">Das Lernjournal hilft dir, deinen eigenen Lernprozess zu dokumentieren und zu reflektieren. Es geht nicht darum, den Unterricht einfach nachzuerzählen.</div></details>
    <details><summary>Was gehört in ein gutes Lernjournal?</summary><div class="help-answer">Frage dich: Was habe ich verstanden? Was kann ich jetzt erklären? Wo kann ich das Wissen anwenden? Was war schwierig? Was möchte ich weiter üben? Was nehme ich für mein eigenes Handeln mit?</div></details>
    <details><summary>Was ist eine gute Reflexion?</summary><div class="help-answer"><strong>Weniger hilfreich:</strong> „Heute haben wir Konditionierung gelernt.“<br><br><strong>Hilfreicher:</strong> „Ich kann jetzt erklären, warum ein ursprünglich neutraler Reiz durch wiederholte Kopplung eine Reaktion auslösen kann. Das erkenne ich beispielsweise an …“</div></details>
  </section>

  <section class="card help-section" id="weiterkommen">
    <span class="badge">🧭 LERNHILFE</span><h2>Ich komme bei einer Aufgabe nicht weiter.</h2>
    <p>Versuche zunächst selbst weiterzukommen:</p>
    <div class="help-steps">
      <div class="help-step"><div><strong>Aufgabe genau lesen</strong><br>Was wird tatsächlich gefragt?</div></div>
      <div class="help-step"><div><strong>Fachbegriffe markieren</strong><br>Welche Begriffe aus dem Unterricht könnten wichtig sein?</div></div>
      <div class="help-step"><div><strong>Thema bestimmen</strong><br>Zu welchem Thema gehört die Aufgabe?</div></div>
      <div class="help-step"><div><strong>Passendes Modell suchen</strong><br>Welche Theorie oder welches Konzept könnte helfen?</div></div>
      <div class="help-step"><div><strong>Mit einem Beispiel arbeiten</strong><br>Kannst du die Theorie an einem konkreten Beispiel nachvollziehen?</div></div>
      <div class="help-step"><div><strong>Erst selbst versuchen</strong><br>Formuliere zunächst deine eigene Lösung.</div></div>
      <div class="help-step"><div><strong>Dann Unterstützung holen</strong><br>Wenn du weiterhin nicht weiterkommst, frage deine Lehrkraft.</div></div>
    </div>
    <div class="notice" style="margin-top:14px"><strong>💡 Wichtig</strong><p style="margin-bottom:0">Hilfe soll dich beim Denken unterstützen – sie soll dir nicht einfach die Lösung abnehmen.</p></div>
  </section>

  <section class="card help-section help-qa">
    <span class="badge">📅 CAMPUS-KALENDER & 💡 IMPULSE</span><h2>Weitere Funktionen</h2>
    <details><summary>Wofür ist der Campus-Kalender da?</summary><div class="help-answer">Im Campus-Kalender findest du wichtige Termine und Veranstaltungen rund um die Schule. Wenn du dazu berechtigt bist, kannst du selbst Termine eintragen.</div></details>
    <details><summary>Was ist „Impuls für mich“?</summary><div class="help-answer">Hier findest du kurze Impulse, die dich zum Nachdenken, Ausprobieren oder Reflektieren anregen. Du musst nicht jeden Impuls sofort umsetzen. Nimm dir das mit, was gerade zu dir und deiner Situation passt.</div></details>
  </section>

  <section class="card help-section" id="ansprechpartner">
    <span class="badge">👥 ANSPRECHPARTNER</span><h2>Wer kann mir helfen?</h2>
    <div class="help-contact">
      <div class="card"><strong>📚 Unterricht & Fachinhalte</strong><p>Deine Fachlehrkraft</p><small>Fragen zu Lernstoff, Aufgaben, Lernstandsmessungen, Bewertungen und Lernjournal.</small></div>
      <div class="card"><strong>💻 Technische Probleme</strong><p>Schulischer IT-Support / zuständige Lehrkraft</p><small>Fragen zu Anmeldung, Speichern oder technischen Fehlern.</small></div>
      <div class="card"><strong>🤝 Persönliche Fragen</strong><p>Die vorgesehenen Beratungs- und Vertrauenspersonen der Schule</p><small>Wenn dich eine Aufgabe oder Situation persönlich beschäftigt.</small></div>
    </div>
  </section>

  ${isTeacherRole?`
  <section class="card help-section help-qa">
    <span class="badge">👩‍🏫 FÜR LEHRKRÄFTE</span><h2>Hilfe bei der Arbeit mit der Campus-App</h2>
    <details><summary>Lernstandsmessungen verwalten</summary><div class="help-answer">Aufgaben und Musterlösungen können gepflegt und den 26 vorgesehenen Lernstandsmessungen zugeordnet werden.</div></details>
    <details><summary>Schülerleistungen ansehen</summary><div class="help-answer">Die Schülerübersicht zeigt Bearbeitungsstände. Einzelne Schüler können geöffnet und einzelne Versuche eingesehen und bewertet werden.</div></details>
    <details><summary>Kompetenzentwicklung verfolgen</summary><div class="help-answer">Die fünf Kompetenzdimensionen werden über die Lernstandsmessungen hinweg dokumentiert und machen Lernfortschritte sichtbar.</div></details>
  </section>`:""}

  <section class="card help-section">
    <span class="badge">🧭 CAMPUS-APP AUF EINEN BLICK</span>
    <div class="grid grid-3">
      <div><strong>📚 Lernen</strong><p>Lernwerkstatt, Lernstandsmessungen und Lernressourcen.</p></div>
      <div><strong>📝 Lernjournal</strong><p>Lernweg, Reflexionen und nächste Schritte.</p></div>
      <div><strong>📊 Kompetenzentwicklung</strong><p>Deine Entwicklung in den fünf Kompetenzdimensionen.</p></div>
      <div><strong>📅 Campus-Kalender</strong><p>Wichtige Termine und Veranstaltungen.</p></div>
      <div><strong>💡 Impuls für mich</strong><p>Kurze Impulse für Schul- und Lernalltag.</p></div>
      <div><strong>❓ Fragen & Hilfe</strong><p>Antworten, Lernhilfe und Ansprechpartner.</p></div>
    </div>
  </section>
  ${footer()}`;
}
...
async function renderKalender(){
  ...
  if(!events.length){try{events=await getCollection("calendar","date",false)}catch(_){}}
  ...
  const dateVal=e=>{
    const raw=e.start||e.date||e.startDate;if(!raw)return null;
    if(typeof raw==="object"&&raw.seconds)return new Date(raw.seconds*1000);
    const d=new Date(String(raw).slice(0,10)+"T00:00:00");return isNaN(d)?null:d;
  };
  const eventsForDay=(y,m,d)=>events.filter(e=>{const x=dateVal(e);return x&&x.getFullYear()===y&&x.getMonth()===m&&x.getDate()===d});
  const monthHTML=(y,m,name)=>{
    ...
    for(let d=1;d<=days;d++){
      ...
      cells.push(`<button type="button" class="cal-day ${ds.length?"has-event":""}" onclick="openCalendarDay(${y},${m},${d})"><span class="cal-num">${d}</span>${ds.length?`<span class="cal-dot"></span><span class="cal-count">${ds.length}</span>`:""}</button>`);
    }
    while(cells.length%7)cells.push('<div class="cal-day empty"></div>');
    return `<section class="card cal-month"><div class="cal-month-head"><h2>${name}</h2></div><div class="cal-week">${week.map(x=>`<div>${x}</div>`).join("")}</div><div class="cal-grid">${cells.join("")}</div></section>`;
  };
  window._campusCalendarEvents=events;
  const html=`${pageHead("ORGANISATION","Campus-Kalender","Das Schuljahr 26/27 auf einen Blick. Monate mit Terminen sind sofort erkennbar.",'<button id="calendarAddBtn" class="primary" type="button">＋ Termin eintragen</button>')}
  <style>.cal-months{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:18px}.cal-month{padding:18px}.cal-month-head{margin-bottom:10px}.cal-week,.cal-grid{display:grid;grid-template-columns:repeat(7,minmax(0,1fr));gap:4px}.cal-week{font-size:12px;color:var(--muted);text-align:center}.cal-day{min-height:52px;border:1px solid var(--line);border-radius:9px;background:#fff;padding:7px;text-align:left;cursor:pointer}.cal-day.empty{border:0;background:transparent;cursor:default}.cal-day.has-event{border-color:var(--brand,#168fd0)}.cal-dot{display:inline-block;width:7px;height:7px;border-radius:50%;background:var(--brand,#168fd0);margin-left:5px}@media(max-width:800px){.cal-months{grid-template-columns:1fr}}</style>
  <div class="card" style="margin-bottom:16px"><strong>Campus-Kalender</strong><p>Termine werden im gemeinsamen Kalender gespeichert. Klicke auf einen Tag, um vorhandene Termine zu sehen.</p></div>
...
function openCalendarDay(y,m,d){
  ...
  modal(`<button class="modal-close" onclick="closeModal()">×</button>
    ...
    <div class="form-actions"><button class="secondary" onclick="closeModal()">Schließen</button>
      <button class="primary" onclick="closeModal();setTimeout(openCalendarForm,50)">＋ Termin eintragen</button></div>`);
}
...
async function render(){
  ...
  const pages={
    ...
    impulse:renderLernimpulse,fragenhilfe:renderFragenHilfe,lernstand:renderLernstand,
...
function openCalendarForm(){
  ...
  modal(`<button class="modal-close" type="button" onclick="closeModal()">×</button><div class="kicker">CAMPUS-KALENDER</div><h2>Neuen Termin eintragen</h2>
  <div class="form"><label>Titel *<input id="calTitle" type="text" placeholder="z. B. Pädagogischer Halbtag"></label>
  <label>Datum *<input id="calDate" type="date"></label><label>Uhrzeit<input id="calTime" type="time"></label>
  <label>Ort<input id="calLocation" type="text" placeholder="z. B. F203"></label>
  <label>Beschreibung<textarea id="calDescription" rows="4"></textarea></label>
  <div class="form-actions"><button class="secondary" type="button" onclick="closeModal()">Abbrechen</button><button id="calendarSaveBtn" class="primary" type="button">Termin speichern</button></div></div>`);
  const d=new Date();d.setMinutes(d.getMinutes()-d.getTimezoneOffset());$("calDate").value=d.toISOString().slice(0,10);
...
async function addCalendar(){
  if(!currentUser){toast("Bitte zuerst anmelden.");return}
  const title=$("calTitle")?.value.trim()||"",date=$("calDate")?.value||"",time=$("calTime")?.value||"",location=$("calLocation")?.value.trim()||"",description=$("calDescription")?.value.trim()||"";
  if(!title){toast("Bitte einen Titel eingeben.");return}
  if(!date){toast("Bitte ein Datum auswählen.");return}
  const payload={title,date,start:date,time,location,description,createdBy:currentUser.uid,createdByName:profile?.displayName||currentUser.email||"Campus-Mitglied",createdAt:serverTimestamp(),updatedAt:serverTimestamp()};
